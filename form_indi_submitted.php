        ...
        <div class="row"> 
         ...
         <div class="col-md-12 form-group">
          ...
          <div class="col-md-12 pt-3">
            <h2 class="text-center">Remmitance request is  successfully submitted!</h2><br>
          </div>

          <div class="col-md-12">
            <a href='mypage.php' class="btn bg-success text-white col-md-4 mt-5 d-block mx-auto">Go to My Page</a>
